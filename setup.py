...
setup(
    ...
    long_description="""\
        Python Client for Logto API. To learn more about how to interact with Logto APIs, see [Interact with Management API](https://docs.logto.io/docs/recipes/interact-with-management-api/).
        """,  # noqa: E501
