...
class GetApplicationSignInExperience200ResponseColor(BaseModel):
    """
    GetApplicationSignInExperience200ResponseColor
    """ # noqa: E501
    primary_color: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, alias="primaryColor")
    is_dark_mode_enabled: Optional[StrictBool] = Field(default=None, alias="isDarkModeEnabled")
    dark_primary_color: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, alias="darkPrimaryColor")
