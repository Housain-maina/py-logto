...
class CreateWebAuthnRegistrationVerification200ResponseRegistrationOptionsPubKeyCredParamsInner(BaseModel):
    """
    CreateWebAuthnRegistrationVerification200ResponseRegistrationOptionsPubKeyCredParamsInner
    """ # noqa: E501
    type: StrictStr
    alg: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["type", "alg"]
