...
class ListHooks200ResponseInner(BaseModel):
    """
    ...
    execution_stats: Optional[ListHooks200ResponseInnerExecutionStats] = Field(default=None, alias="executionStats")
    __properties: ClassVar[List[str]] = ["tenantId", "id", "name", "event", "events", "config", "signingKey", "enabled", "createdAt", "executionStats"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "config": ListHooks200ResponseInnerConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
            "signingKey": obj.get("signingKey"),
            "enabled": obj.get("enabled"),
            "createdAt": obj.get("createdAt"),
            "executionStats": ListHooks200ResponseInnerExecutionStats.from_dict(obj["executionStats"]) if obj.get("executionStats") is not None else None
        })
        return _obj
