...
class ApiInteractionConsentGet200ResponseApplication(BaseModel):
    """
    ...
    privacy_policy_url: Optional[Annotated[str, Field(strict=True, max_length=2048)]] = Field(default=None, alias="privacyPolicyUrl")
    terms_of_use_url: Optional[Annotated[str, Field(strict=True, max_length=2048)]] = Field(default=None, alias="termsOfUseUrl")
    __properties: ClassVar[List[str]] = ["id", "name", "branding", "displayName", "privacyPolicyUrl", "termsOfUseUrl"]
