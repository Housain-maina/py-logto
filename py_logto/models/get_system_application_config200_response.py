...
class GetSystemApplicationConfig200Response(BaseModel):
    """
    GetSystemApplicationConfig200Response
    """ # noqa: E501
    protected_apps: GetSystemApplicationConfig200ResponseProtectedApps = Field(alias="protectedApps")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "protectedApps": GetSystemApplicationConfig200ResponseProtectedApps.from_dict(obj["protectedApps"]) if obj.get("protectedApps") is not None else None
        })
        return _obj
