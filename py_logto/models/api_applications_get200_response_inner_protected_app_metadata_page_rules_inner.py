...
class ApiApplicationsGet200ResponseInnerProtectedAppMetadataPageRulesInner(BaseModel):
    """
    ApiApplicationsGet200ResponseInnerProtectedAppMetadataPageRulesInner
    """ # noqa: E501
    path: StrictStr
