...
class CreateNewPasswordIdentityVerificationRequest(BaseModel):
    """
    CreateNewPasswordIdentityVerificationRequest
    """ # noqa: E501
    identifier: CreateNewPasswordIdentityVerificationRequestIdentifier
    password: StrictStr = Field(description="The new user password. (A password digest will be created and stored securely in the verification record.)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "identifier": CreateNewPasswordIdentityVerificationRequestIdentifier.from_dict(obj["identifier"]) if obj.get("identifier") is not None else None,
