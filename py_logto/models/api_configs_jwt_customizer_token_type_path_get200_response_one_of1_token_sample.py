...
class ApiConfigsJwtCustomizerTokenTypePathGet200ResponseOneOf1TokenSample(BaseModel):
    """
    ApiConfigsJwtCustomizerTokenTypePathGet200ResponseOneOf1TokenSample
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["jti", "aud", "scope", "clientId", "kind"]
