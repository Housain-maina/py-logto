...
class ListUserPersonalAccessTokens200ResponseInner(BaseModel):
    """
    ListUserPersonalAccessTokens200ResponseInner
    """ # noqa: E501
    tenant_id: Annotated[str, Field(strict=True, max_length=21)] = Field(alias="tenantId")
    user_id: Annotated[str, Field(min_length=1, strict=True, max_length=21)] = Field(alias="userId")
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "userId", "name", "value", "createdAt", "expiresAt"]
