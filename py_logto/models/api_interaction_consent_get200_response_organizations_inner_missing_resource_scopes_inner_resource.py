...
class ApiInteractionConsentGet200ResponseOrganizationsInnerMissingResourceScopesInnerResource(BaseModel):
    """
    ...
    id: StrictStr
    __properties: ClassVar[List[str]] = ["name", "indicator", "id"]
