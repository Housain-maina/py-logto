...
class UpdateApplicationRequestProtectedAppMetadata(BaseModel):
    """
    ...
    page_rules: Optional[List[ListApplications200ResponseInnerProtectedAppMetadataPageRulesInner]] = Field(default=None, alias="pageRules")
