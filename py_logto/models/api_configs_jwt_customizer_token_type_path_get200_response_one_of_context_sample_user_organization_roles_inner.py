...
class ApiConfigsJwtCustomizerTokenTypePathGet200ResponseOneOfContextSampleUserOrganizationRolesInner(BaseModel):
    """
    ApiConfigsJwtCustomizerTokenTypePathGet200ResponseOneOfContextSampleUserOrganizationRolesInner
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["organizationId", "roleId", "roleName"]
