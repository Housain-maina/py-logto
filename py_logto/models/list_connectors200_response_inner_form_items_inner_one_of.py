...
class ListConnectors200ResponseInnerFormItemsInnerOneOf(BaseModel):
    """
    ListConnectors200ResponseInnerFormItemsInnerOneOf
    """ # noqa: E501
    type: StrictStr
    select_items: List[ListConnectors200ResponseInnerFormItemsInnerOneOfSelectItemsInner] = Field(alias="selectItems")
    key: StrictStr
    label: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "selectItems": [ListConnectors200ResponseInnerFormItemsInnerOneOfSelectItemsInner.from_dict(_item) for _item in obj["selectItems"]] if obj.get("selectItems") is not None else None,
            "key": obj.get("key"),
            "label": obj.get("label"),
