...
class ApiConfigsAdminConsoleGet200Response(BaseModel):
    """
    ApiConfigsAdminConsoleGet200Response
    """ # noqa: E501
    sign_in_experience_customized: StrictBool = Field(alias="signInExperienceCustomized")
    organization_created: StrictBool = Field(alias="organizationCreated")
