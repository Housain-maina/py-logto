...
class ApiDomainsPostRequest(BaseModel):
    """
    ApiDomainsPostRequest
    """ # noqa: E501
    domain: Annotated[str, Field(min_length=1, strict=True, max_length=256)] = Field(description="The domain name, e.g. `example.com`.")
