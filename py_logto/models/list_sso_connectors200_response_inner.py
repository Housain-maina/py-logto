...
class ListSsoConnectors200ResponseInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "id", "providerName", "connectorName", "config", "domains", "branding", "syncProfile", "createdAt", "name", "providerType", "providerLogo", "providerLogoDark", "providerConfig"]
