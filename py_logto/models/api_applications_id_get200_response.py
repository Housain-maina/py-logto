...
class ApiApplicationsIdGet200Response(BaseModel):
    """
    ...
    type: StrictStr
    oidc_client_metadata: ApiApplicationsGet200ResponseInnerOidcClientMetadata = Field(alias="oidcClientMetadata")
    custom_client_metadata: ApiApplicationsGet200ResponseInnerCustomClientMetadata = Field(alias="customClientMetadata")
    protected_app_metadata: Optional[ApiApplicationsGet200ResponseInnerProtectedAppMetadata] = Field(alias="protectedAppMetadata")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "secret", "description", "type", "oidcClientMetadata", "customClientMetadata", "protectedAppMetadata", "isThirdParty", "createdAt", "isAdmin"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "protectedAppMetadata": ApiApplicationsGet200ResponseInnerProtectedAppMetadata.from_dict(obj["protectedAppMetadata"]) if obj.get("protectedAppMetadata") is not None else None,
