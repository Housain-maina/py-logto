...
class ApiApplicationsApplicationIdUserConsentScopesGet200ResponseResourceScopesInner(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "resource": ApiApplicationsApplicationIdUserConsentScopesGet200ResponseResourceScopesInnerResource.from_dict(obj["resource"]) if obj.get("resource") is not None else None,
