...
class ApiInteractionConsentGet200ResponseMissingResourceScopesInner(BaseModel):
    """
    ApiInteractionConsentGet200ResponseMissingResourceScopesInner
    """ # noqa: E501
    resource: ApiInteractionConsentGet200ResponseMissingResourceScopesInnerResource
    scopes: List[ApiInteractionConsentGet200ResponseMissingResourceScopesInnerScopesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "resource": ApiInteractionConsentGet200ResponseMissingResourceScopesInnerResource.from_dict(obj["resource"]) if obj.get("resource") is not None else None,
            "scopes": [ApiInteractionConsentGet200ResponseMissingResourceScopesInnerScopesInner.from_dict(_item) for _item in obj["scopes"]] if obj.get("scopes") is not None else None
        })
        return _obj
