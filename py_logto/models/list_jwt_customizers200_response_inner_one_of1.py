...
class ListJwtCustomizers200ResponseInnerOneOf1(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "key": obj.get("key"),
            "value": GetJwtCustomizer200ResponseOneOf1.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
