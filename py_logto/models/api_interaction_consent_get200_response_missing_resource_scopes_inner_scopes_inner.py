...
class ApiInteractionConsentGet200ResponseMissingResourceScopesInnerScopesInner(BaseModel):
    """
    ApiInteractionConsentGet200ResponseMissingResourceScopesInnerScopesInner
    """ # noqa: E501
