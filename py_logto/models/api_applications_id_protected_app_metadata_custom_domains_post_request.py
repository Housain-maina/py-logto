...
class ApiApplicationsIdProtectedAppMetadataCustomDomainsPostRequest(BaseModel):
    """
    ApiApplicationsIdProtectedAppMetadataCustomDomainsPostRequest
    """ # noqa: E501
    domain: StrictStr = Field(description="The domain to be added to the application.")
