...
class ApiConnectorsConnectorIdAuthorizationUriPost200Response(BaseModel):
    """
    ApiConnectorsConnectorIdAuthorizationUriPost200Response
    """ # noqa: E501
    redirect_to: StrictStr = Field(alias="redirectTo")
    redirect_uri: Optional[Any] = Field(default=None, description="The URI to navigate for authentication and authorization in the connected social identity provider.", alias="redirectUri")
    __properties: ClassVar[List[str]] = ["redirectTo", "redirectUri"]
