...
class ListApplications200ResponseInnerProtectedAppMetadataCustomDomainsInnerCloudflareData(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ssl": ListApplications200ResponseInnerProtectedAppMetadataCustomDomainsInnerCloudflareDataSsl.from_dict(obj["ssl"]) if obj.get("ssl") is not None else None,
