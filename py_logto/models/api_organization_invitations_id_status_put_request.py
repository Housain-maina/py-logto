...
class ApiOrganizationInvitationsIdStatusPutRequest(BaseModel):
    """
    ApiOrganizationInvitationsIdStatusPutRequest
    """ # noqa: E501
    status: Optional[Any] = Field(default=None, description="The status of the organization invitation.")
    accepted_user_id: Optional[Any] = Field(default=None, description="The ID of the user who accepted the organization invitation. Required if the status is \"Accepted\".", alias="acceptedUserId")
    __properties: ClassVar[List[str]] = ["status", "acceptedUserId"]
