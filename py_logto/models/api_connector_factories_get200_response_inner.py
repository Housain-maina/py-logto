...
class ApiConnectorFactoriesGet200ResponseInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "isDemo", "id", "target", "name", "description", "logo", "logoDark", "readme", "configTemplate", "formItems", "platform", "isStandard"]
