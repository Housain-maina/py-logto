...
class AddOrganizationApplicationsRequest(BaseModel):
    """
    AddOrganizationApplicationsRequest
    """ # noqa: E501
    application_ids: List[Annotated[str, Field(min_length=1, strict=True)]] = Field(description="The application IDs to add.", alias="applicationIds")
