...
class ApiConfigsJwtCustomizerTokenTypePathGet200ResponseOneOfContextSampleUserIdentitiesValue(BaseModel):
    """
    ApiConfigsJwtCustomizerTokenTypePathGet200ResponseOneOfContextSampleUserIdentitiesValue
    """ # noqa: E501
    user_id: StrictStr = Field(alias="userId")
    details: Optional[Dict[str, Any]] = Field(default=None, description="arbitrary")
