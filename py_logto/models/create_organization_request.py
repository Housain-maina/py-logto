...
class CreateOrganizationRequest(BaseModel):
    ...
    name: Annotated[str, Field(min_length=1, strict=True, max_length=128)] = Field(description="The name of the organization.")
    description: Optional[Annotated[str, Field(strict=True, max_length=256)]] = Field(default=None, description="The description of the organization.")
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "name", "description", "customData", "isMfaRequired", "branding", "createdAt"]
