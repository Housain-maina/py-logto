...
class TestJwtCustomizerRequestOneOf1(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tokenType", "environmentVariables", "script", "token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "token": GetJwtCustomizer200ResponseOneOf1TokenSample.from_dict(obj["token"]) if obj.get("token") is not None else None
        })
        return _obj
