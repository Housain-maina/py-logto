...
class UpdateSignInExp200ResponseSignIn(BaseModel):
    """
    UpdateSignInExp200ResponseSignIn
    """ # noqa: E501
    methods: List[GetSignInExp200ResponseSignInMethodsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "methods": [GetSignInExp200ResponseSignInMethodsInner.from_dict(_item) for _item in obj["methods"]] if obj.get("methods") is not None else None
        })
        return _obj
