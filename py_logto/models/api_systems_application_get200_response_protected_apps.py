...
class ApiSystemsApplicationGet200ResponseProtectedApps(BaseModel):
    """
    ApiSystemsApplicationGet200ResponseProtectedApps
    """ # noqa: E501
    default_domain: StrictStr = Field(alias="defaultDomain")
    __properties: ClassVar[List[str]] = ["defaultDomain"]
