...
class ListApplications200ResponseInnerProtectedAppMetadataCustomDomainsInner(BaseModel):
    """
    ...
    cloudflare_data: Optional[ListApplications200ResponseInnerProtectedAppMetadataCustomDomainsInnerCloudflareData] = Field(alias="cloudflareData")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cloudflareData": ListApplications200ResponseInnerProtectedAppMetadataCustomDomainsInnerCloudflareData.from_dict(obj["cloudflareData"]) if obj.get("cloudflareData") is not None else None
        })
        return _obj
