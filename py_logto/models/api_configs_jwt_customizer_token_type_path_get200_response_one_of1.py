...
class ApiConfigsJwtCustomizerTokenTypePathGet200ResponseOneOf1(BaseModel):
    """
    ApiConfigsJwtCustomizerTokenTypePathGet200ResponseOneOf1
    """ # noqa: E501
    ...
    context_sample: Optional[Dict[str, Any]] = Field(default=None, description="arbitrary", alias="contextSample")
    token_sample: Optional[ApiConfigsJwtCustomizerTokenTypePathGet200ResponseOneOf1TokenSample] = Field(default=None, alias="tokenSample")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tokenSample": ApiConfigsJwtCustomizerTokenTypePathGet200ResponseOneOf1TokenSample.from_dict(obj["tokenSample"]) if obj.get("tokenSample") is not None else None
        })
        return _obj
