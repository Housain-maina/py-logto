...
class ApiOrganizationRolesIdResourceScopesPostRequest(BaseModel):
    """
    ApiOrganizationRolesIdResourceScopesPostRequest
    """ # noqa: E501
    scope_ids: Optional[Any] = Field(default=None, description="An array of resource scope IDs to be assigned. Existed scope IDs assignments will be ignored.", alias="scopeIds")
