...
class ApiApplicationsGet200ResponseInnerProtectedAppMetadata(BaseModel):
    """
    ...
    page_rules: List[ApiApplicationsGet200ResponseInnerProtectedAppMetadataPageRulesInner] = Field(alias="pageRules")
    custom_domains: Optional[List[ApiApplicationsGet200ResponseInnerProtectedAppMetadataCustomDomainsInner]] = Field(default=None, alias="customDomains")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.custom_domains:
            for _item in self.custom_domains:
                if _item:
                    _items.append(_item.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "customDomains": [ApiApplicationsGet200ResponseInnerProtectedAppMetadataCustomDomainsInner.from_dict(_item) for _item in obj["customDomains"]] if obj.get("customDomains") is not None else None
        })
        return _obj
