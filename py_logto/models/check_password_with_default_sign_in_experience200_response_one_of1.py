...
class CheckPasswordWithDefaultSignInExperience200ResponseOneOf1(BaseModel):
    """
    CheckPasswordWithDefaultSignInExperience200ResponseOneOf1
    """ # noqa: E501
    result: StrictBool
    issues: List[CheckPasswordWithDefaultSignInExperience200ResponseOneOf1IssuesInner]
    __properties: ClassVar[List[str]] = ["result", "issues"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "issues": [CheckPasswordWithDefaultSignInExperience200ResponseOneOf1IssuesInner.from_dict(_item) for _item in obj["issues"]] if obj.get("issues") is not None else None
        })
        return _obj
