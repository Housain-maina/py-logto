...
class ApiUsersUserIdProfilePatchRequest(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "profile": ApiUsersUserIdProfilePatchRequestProfile.from_dict(obj["profile"]) if obj.get("profile") is not None else None
        })
        return _obj
