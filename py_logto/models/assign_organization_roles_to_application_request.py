...
class AssignOrganizationRolesToApplicationRequest(BaseModel):
    """
    AssignOrganizationRolesToApplicationRequest
    """ # noqa: E501
    organization_role_ids: List[Annotated[str, Field(min_length=1, strict=True)]] = Field(description="The role ID to add.", alias="organizationRoleIds")
