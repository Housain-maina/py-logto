...
class ApiSignInExpGet200ResponsePasswordPolicyCharacterTypes(BaseModel):
    """
    ApiSignInExpGet200ResponsePasswordPolicyCharacterTypes
    """ # noqa: E501
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "min": obj.get("min") if obj.get("min") is not None else 1
        })
        return _obj
