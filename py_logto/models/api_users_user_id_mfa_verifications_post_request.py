...
class ApiUsersUserIdMfaVerificationsPostRequest(BaseModel):
    """
    ApiUsersUserIdMfaVerificationsPostRequest
    """ # noqa: E501
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": ApiUsersUserIdMfaVerificationsPostRequestType.from_dict(obj["type"]) if obj.get("type") is not None else None
        })
        return _obj
