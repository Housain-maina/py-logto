...
class ApiConfigsJwtCustomizerTokenTypePathGet200ResponseOneOfContextSampleUserRolesInnerScopesInnerResource(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "indicator", "isDefault", "accessTokenTtl"]
