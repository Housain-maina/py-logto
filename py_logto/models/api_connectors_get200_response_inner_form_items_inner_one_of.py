...
class ApiConnectorsGet200ResponseInnerFormItemsInnerOneOf(BaseModel):
    """
    ApiConnectorsGet200ResponseInnerFormItemsInnerOneOf
    """ # noqa: E501
    type: StrictStr
    select_items: List[ApiConnectorsGet200ResponseInnerFormItemsInnerOneOfSelectItemsInner] = Field(alias="selectItems")
    key: StrictStr
    label: StrictStr
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.select_items:
            for _item in self.select_items:
                if _item:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "selectItems": [ApiConnectorsGet200ResponseInnerFormItemsInnerOneOfSelectItemsInner.from_dict(_item) for _item in obj["selectItems"]] if obj.get("selectItems") is not None else None,
            "key": obj.get("key"),
            "label": obj.get("label"),
