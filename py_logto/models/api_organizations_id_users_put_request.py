...
class ApiOrganizationsIdUsersPutRequest(BaseModel):
    """
    ApiOrganizationsIdUsersPutRequest
    """ # noqa: E501
    user_ids: List[Annotated[str, Field(min_length=1, strict=True)]] = Field(description="An array of user IDs to replace existing users.", alias="userIds")
