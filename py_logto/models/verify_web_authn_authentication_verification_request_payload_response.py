...
class VerifyWebAuthnAuthenticationVerificationRequestPayloadResponse(BaseModel):
    """
    VerifyWebAuthnAuthenticationVerificationRequestPayloadResponse
    """ # noqa: E501
    client_data_json: StrictStr = Field(alias="clientDataJSON")
    authenticator_data: StrictStr = Field(alias="authenticatorData")
    signature: StrictStr
    user_handle: Optional[StrictStr] = Field(default=None, alias="userHandle")
    __properties: ClassVar[List[str]] = ["clientDataJSON", "authenticatorData", "signature", "userHandle"]
