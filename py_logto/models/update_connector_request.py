...
class UpdateConnectorRequest(BaseModel):
    ...
    metadata: Optional[UpdateConnectorRequestMetadata] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "metadata": UpdateConnectorRequestMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
