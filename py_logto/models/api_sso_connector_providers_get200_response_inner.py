...
class ApiSsoConnectorProvidersGet200ResponseInner(BaseModel):
    """
    ...
    logo: StrictStr
    logo_dark: StrictStr = Field(alias="logoDark")
    description: StrictStr
    name: StrictStr
    __properties: ClassVar[List[str]] = ["providerName", "providerType", "logo", "logoDark", "description", "name"]
