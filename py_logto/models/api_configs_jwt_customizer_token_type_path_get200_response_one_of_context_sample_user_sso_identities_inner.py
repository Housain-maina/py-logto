...
class ApiConfigsJwtCustomizerTokenTypePathGet200ResponseOneOfContextSampleUserSsoIdentitiesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["issuer", "identityId", "detail"]
