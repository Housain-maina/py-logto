...
class ApiApplicationsGet200ResponseInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "secret", "description", "type", "oidcClientMetadata", "customClientMetadata", "protectedAppMetadata", "isThirdParty", "createdAt"]
