...
class VerifyWebAuthnAuthenticationVerification200Response(BaseModel):
    """
    VerifyWebAuthnAuthenticationVerification200Response
    """ # noqa: E501
    verification_id: StrictStr = Field(description="The unique verification ID of the WebAuthn authentication verification record.", alias="verificationId")
