...
class ListLogs200ResponseInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "id", "key", "payload", "createdAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "key": obj.get("key"),
            "payload": ListLogs200ResponseInnerPayload.from_dict(obj["payload"]) if obj.get("payload") is not None else None,
