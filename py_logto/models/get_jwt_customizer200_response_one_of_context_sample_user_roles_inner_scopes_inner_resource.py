...
class GetJwtCustomizer200ResponseOneOfContextSampleUserRolesInnerScopesInnerResource(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "id", "name", "indicator", "isDefault", "accessTokenTtl"]
