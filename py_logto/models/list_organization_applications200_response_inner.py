...
class ListOrganizationApplications200ResponseInner(BaseModel):
    """
    ...
    secret: StrictStr = Field(description="The internal client secret. Note it is only used for internal validation, and the actual secrets should be retrieved from `/api/applications/{id}/secrets` endpoints.")
    description: Optional[StrictStr]
    type: StrictStr
    oidc_client_metadata: ListApplications200ResponseInnerOidcClientMetadata = Field(alias="oidcClientMetadata")
    custom_client_metadata: ListApplications200ResponseInnerCustomClientMetadata = Field(alias="customClientMetadata")
    protected_app_metadata: Optional[ListApplications200ResponseInnerProtectedAppMetadata] = Field(alias="protectedAppMetadata")
    custom_data: Dict[str, Any] = Field(description="arbitrary", alias="customData")
    is_third_party: StrictBool = Field(alias="isThirdParty")
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "id", "name", "secret", "description", "type", "oidcClientMetadata", "customClientMetadata", "protectedAppMetadata", "customData", "isThirdParty", "createdAt", "organizationRoles"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.organization_roles:
            for _item_organization_roles in self.organization_roles:
                if _item_organization_roles:
                    _items.append(_item_organization_roles.to_dict())
        ...
        # set to None if protected_app_metadata (nullable) is None
        # and model_fields_set contains the field
        if self.protected_app_metadata is None and "protected_app_metadata" in self.model_fields_set:
            _dict['protectedAppMetadata'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "protectedAppMetadata": ListApplications200ResponseInnerProtectedAppMetadata.from_dict(obj["protectedAppMetadata"]) if obj.get("protectedAppMetadata") is not None else None,
