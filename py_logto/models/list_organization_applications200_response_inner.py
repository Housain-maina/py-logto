...
class ListOrganizationApplications200ResponseInner(BaseModel):
    ...
    secret: Annotated[str, Field(min_length=1, strict=True, max_length=64)]
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "id", "name", "secret", "description", "type", "oidcClientMetadata", "customClientMetadata", "protectedAppMetadata", "isThirdParty", "createdAt", "organizationRoles"]
