...
class ApiConfigsJwtCustomizerTokenTypePathGet200ResponseOneOfContextSample(BaseModel):
    """
    ApiConfigsJwtCustomizerTokenTypePathGet200ResponseOneOfContextSample
    """ # noqa: E501
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "user": ApiConfigsJwtCustomizerTokenTypePathGet200ResponseOneOfContextSampleUser.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
        return _obj
