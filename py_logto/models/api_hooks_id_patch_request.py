...
class ApiHooksIdPatchRequest(BaseModel):
    """
    ...
    config: Optional[ApiHooksPostRequestConfig] = None
    enabled: Optional[StrictBool] = None
    created_at: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="createdAt")
    __properties: ClassVar[List[str]] = ["name", "event", "events", "config", "enabled", "createdAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "config": ApiHooksPostRequestConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
