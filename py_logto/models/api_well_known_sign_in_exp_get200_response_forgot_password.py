...
class ApiWellKnownSignInExpGet200ResponseForgotPassword(BaseModel):
    """
    ApiWellKnownSignInExpGet200ResponseForgotPassword
    """ # noqa: E501
    phone: StrictBool
    email: StrictBool
    __properties: ClassVar[List[str]] = ["phone", "email"]
