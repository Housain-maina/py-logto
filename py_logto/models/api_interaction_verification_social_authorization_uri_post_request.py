...
class ApiInteractionVerificationSocialAuthorizationUriPostRequest(BaseModel):
    """
    ApiInteractionVerificationSocialAuthorizationUriPostRequest
    """ # noqa: E501
    connector_id: StrictStr = Field(alias="connectorId")
    state: StrictStr
    redirect_uri: Dict[str, Any] = Field(description="Validator function", alias="redirectUri")
    __properties: ClassVar[List[str]] = ["connectorId", "state", "redirectUri"]
