...
class GetJwtCustomizer200ResponseOneOfContextSampleUserProfile(BaseModel):
    """
    ...
    address: Optional[GetJwtCustomizer200ResponseOneOfContextSampleUserProfileAddress] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "address": GetJwtCustomizer200ResponseOneOfContextSampleUserProfileAddress.from_dict(obj["address"]) if obj.get("address") is not None else None
        })
        return _obj
