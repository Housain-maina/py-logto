...
class CreateOrganizationJitEmailDomainRequest(BaseModel):
    """
    CreateOrganizationJitEmailDomainRequest
    """ # noqa: E501
    email_domain: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The email domain to add.", alias="emailDomain")
    __properties: ClassVar[List[str]] = ["emailDomain"]
