...
class ListApplications200ResponseInnerProtectedAppMetadataCustomDomainsInnerCloudflareDataSsl(BaseModel):
    """
    ListApplications200ResponseInnerProtectedAppMetadataCustomDomainsInnerCloudflareDataSsl
    """ # noqa: E501
    status: StrictStr
    validation_errors: Optional[List[ListApplications200ResponseInnerProtectedAppMetadataCustomDomainsInnerCloudflareDataSslValidationErrorsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "validation_errors": [ListApplications200ResponseInnerProtectedAppMetadataCustomDomainsInnerCloudflareDataSslValidationErrorsInner.from_dict(_item) for _item in obj["validation_errors"]] if obj.get("validation_errors") is not None else None
        })
        return _obj
