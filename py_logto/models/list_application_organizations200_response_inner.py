...
class ListApplicationOrganizations200ResponseInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "id", "name", "description", "customData", "isMfaRequired", "branding", "createdAt", "organizationRoles"]
