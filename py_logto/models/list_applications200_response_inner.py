...
class ListApplications200ResponseInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "id", "name", "secret", "description", "type", "oidcClientMetadata", "customClientMetadata", "protectedAppMetadata", "isThirdParty", "createdAt"]
