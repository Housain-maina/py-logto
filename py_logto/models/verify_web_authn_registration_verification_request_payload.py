...
class VerifyWebAuthnRegistrationVerificationRequestPayload(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "rawId": obj.get("rawId"),
            "response": VerifyWebAuthnRegistrationVerificationRequestPayloadResponse.from_dict(obj["response"]) if obj.get("response") is not None else None,
