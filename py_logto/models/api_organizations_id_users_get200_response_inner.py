...
class ApiOrganizationsIdUsersGet200ResponseInner(BaseModel):
    """
    ...
    organization_roles: List[ApiUsersUserIdOrganizationsGet200ResponseInnerOrganizationRolesInner] = Field(alias="organizationRoles")
    __properties: ClassVar[List[str]] = ["id", "username", "primaryEmail", "primaryPhone", "name", "avatar", "customData", "identities", "lastSignInAt", "createdAt", "updatedAt", "profile", "applicationId", "isSuspended", "organizationRoles"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "organizationRoles": [ApiUsersUserIdOrganizationsGet200ResponseInnerOrganizationRolesInner.from_dict(_item) for _item in obj["organizationRoles"]] if obj.get("organizationRoles") is not None else None
        })
        return _obj
