...
class GetJwtCustomizer200ResponseOneOfContextSampleUserRolesInnerScopesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "resourceId", "resource"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "resource": GetJwtCustomizer200ResponseOneOfContextSampleUserRolesInnerScopesInnerResource.from_dict(obj["resource"]) if obj.get("resource") is not None else None
        })
        return _obj
