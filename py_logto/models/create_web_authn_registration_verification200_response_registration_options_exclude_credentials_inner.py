...
class CreateWebAuthnRegistrationVerification200ResponseRegistrationOptionsExcludeCredentialsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "id", "transports"]
