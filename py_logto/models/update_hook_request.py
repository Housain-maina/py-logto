...
class UpdateHookRequest(BaseModel):
    ...
    name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=256)]] = Field(default=None, description="The updated name of the hook.")
    event: Optional[StrictStr] = Field(default=None, description="Use `events` instead.")
    events: Optional[List[StrictStr]] = Field(default=None, description="An array of updated hook events.")
    config: Optional[CreateHookRequestConfig] = None
    enabled: Optional[StrictBool] = None
    created_at: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="createdAt")
    __properties: ClassVar[List[str]] = ["tenantId", "name", "event", "events", "config", "enabled", "createdAt"]
    ...
    def event_validate_enum(cls, value):
        ...
        if value not in set(['PostRegister', 'PostSignIn', 'PostResetPassword', 'User.Created', 'User.Deleted', 'User.Data.Updated', 'User.SuspensionStatus.Updated', 'Role.Created', 'Role.Deleted', 'Role.Data.Updated', 'Role.Scopes.Updated', 'Scope.Created', 'Scope.Deleted', 'Scope.Data.Updated', 'Organization.Created', 'Organization.Deleted', 'Organization.Data.Updated', 'Organization.Membership.Updated', 'OrganizationRole.Created', 'OrganizationRole.Deleted', 'OrganizationRole.Data.Updated', 'OrganizationRole.Scopes.Updated', 'OrganizationScope.Created', 'OrganizationScope.Deleted', 'OrganizationScope.Data.Updated']):
            raise ValueError("must be one of enum values ('PostRegister', 'PostSignIn', 'PostResetPassword', 'User.Created', 'User.Deleted', 'User.Data.Updated', 'User.SuspensionStatus.Updated', 'Role.Created', 'Role.Deleted', 'Role.Data.Updated', 'Role.Scopes.Updated', 'Scope.Created', 'Scope.Deleted', 'Scope.Data.Updated', 'Organization.Created', 'Organization.Deleted', 'Organization.Data.Updated', 'Organization.Membership.Updated', 'OrganizationRole.Created', 'OrganizationRole.Deleted', 'OrganizationRole.Data.Updated', 'OrganizationRole.Scopes.Updated', 'OrganizationScope.Created', 'OrganizationScope.Deleted', 'OrganizationScope.Data.Updated')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "config": CreateHookRequestConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
