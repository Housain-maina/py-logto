...
class ListCustomPhrases200ResponseInner(BaseModel):
    """
    ...
    language_tag: Annotated[str, Field(min_length=1, strict=True, max_length=16)] = Field(alias="languageTag")
    translation: TranslationObject
    __properties: ClassVar[List[str]] = ["tenantId", "id", "languageTag", "translation"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "translation": TranslationObject.from_dict(obj["translation"]) if obj.get("translation") is not None else None
        })
        return _obj
