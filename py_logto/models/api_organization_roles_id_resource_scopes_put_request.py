...
class ApiOrganizationRolesIdResourceScopesPutRequest(BaseModel):
    """
    ApiOrganizationRolesIdResourceScopesPutRequest
    """ # noqa: E501
    scope_ids: Optional[Any] = Field(default=None, description="An array of resource scope IDs to replace existing scopes.", alias="scopeIds")
