...
class ApiResourcesResourceIdScopesScopeIdPatchRequest(BaseModel):
    """
    ApiResourcesResourceIdScopesScopeIdPatchRequest
    """ # noqa: E501
    name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=256)]] = Field(default=None, description="The updated name of the scope. It should be unique for the resource.")
