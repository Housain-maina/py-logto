...
class ApiSignInExpPatch200ResponseSignIn(BaseModel):
    """
    ApiSignInExpPatch200ResponseSignIn
    """ # noqa: E501
    methods: List[ApiSignInExpGet200ResponseSignInMethodsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "methods": [ApiSignInExpGet200ResponseSignInMethodsInner.from_dict(_item) for _item in obj["methods"]] if obj.get("methods") is not None else None
        })
        return _obj
