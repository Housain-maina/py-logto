...
class ApiInteractionMfaPutRequestOneOf(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "response": ApiInteractionMfaPutRequestOneOfResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
