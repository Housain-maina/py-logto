...
class ApiConfigsJwtCustomizerTokenTypePathGet200ResponseOneOfContextSampleUserProfileAddress(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["formatted", "streetAddress", "locality", "region", "postalCode", "country"]
