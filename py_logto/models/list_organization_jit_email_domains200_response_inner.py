...
class ListOrganizationJitEmailDomains200ResponseInner(BaseModel):
    """
    ...
    email_domain: Annotated[str, Field(min_length=1, strict=True, max_length=128)] = Field(alias="emailDomain")
    __properties: ClassVar[List[str]] = ["tenantId", "organizationId", "emailDomain"]
