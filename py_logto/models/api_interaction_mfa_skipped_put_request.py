...
class ApiInteractionMfaSkippedPutRequest(BaseModel):
    """
    ApiInteractionMfaSkippedPutRequest
    """ # noqa: E501
    mfa_skipped: StrictBool = Field(alias="mfaSkipped")
    __properties: ClassVar[List[str]] = ["mfaSkipped"]
