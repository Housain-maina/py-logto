...
class ApiResourcesResourceIdScopesPostRequest(BaseModel):
    """
    ApiResourcesResourceIdScopesPostRequest
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True, max_length=256)] = Field(description="The name of the scope. It should be unique for the resource.")
