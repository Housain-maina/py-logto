...
class TestJwtCustomizerRequestPayload(BaseModel):
    """
    TestJwtCustomizerRequestPayload
    """ # noqa: E501
    script: Optional[Any] = Field(default=None, description="The code snippet of the JWT customizer.")
    ...
    token_sample: Optional[Any] = Field(default=None, description="The sample token payload for the JWT customizer script testing purpose.", alias="tokenSample")
