...
class GetJwtCustomizer200ResponseOneOf1(BaseModel):
    """
    ...
    token_sample: Optional[GetJwtCustomizer200ResponseOneOf1TokenSample] = Field(default=None, alias="tokenSample")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tokenSample": GetJwtCustomizer200ResponseOneOf1TokenSample.from_dict(obj["tokenSample"]) if obj.get("tokenSample") is not None else None
        })
        return _obj
