...
class ApiConfigsJwtCustomizerGet200ResponseInnerOneOf1(BaseModel):
    """
    ApiConfigsJwtCustomizerGet200ResponseInnerOneOf1
    """ # noqa: E501
    key: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "key": obj.get("key"),
            "value": ApiConfigsJwtCustomizerTokenTypePathGet200ResponseOneOf1.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
