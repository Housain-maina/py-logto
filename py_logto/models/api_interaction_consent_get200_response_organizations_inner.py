...
class ApiInteractionConsentGet200ResponseOrganizationsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "missingResourceScopes"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.missing_resource_scopes:
            for _item_missing_resource_scopes in self.missing_resource_scopes:
                if _item_missing_resource_scopes:
                    _items.append(_item_missing_resource_scopes.to_dict())
