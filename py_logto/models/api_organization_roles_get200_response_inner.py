...
class ApiOrganizationRolesGet200ResponseInner(BaseModel):
    """
    ...
    scopes: List[ApiUsersUserIdOrganizationsGet200ResponseInnerOrganizationRolesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "scopes": [ApiUsersUserIdOrganizationsGet200ResponseInnerOrganizationRolesInner.from_dict(_item) for _item in obj["scopes"]] if obj.get("scopes") is not None else None
        })
        return _obj
