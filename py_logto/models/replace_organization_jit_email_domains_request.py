...
class ReplaceOrganizationJitEmailDomainsRequest(BaseModel):
    """
    ReplaceOrganizationJitEmailDomainsRequest
    """ # noqa: E501
    email_domains: List[StrictStr] = Field(description="An array of email domains to replace existing email domains.", alias="emailDomains")
    __properties: ClassVar[List[str]] = ["emailDomains"]
