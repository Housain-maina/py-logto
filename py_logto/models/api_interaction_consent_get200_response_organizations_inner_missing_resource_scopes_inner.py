...
class ApiInteractionConsentGet200ResponseOrganizationsInnerMissingResourceScopesInner(BaseModel):
    """
    ...
    scopes: List[ApiInteractionConsentGet200ResponseOrganizationsInnerMissingResourceScopesInnerScopesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "resource": ApiInteractionConsentGet200ResponseOrganizationsInnerMissingResourceScopesInnerResource.from_dict(obj["resource"]) if obj.get("resource") is not None else None,
            "scopes": [ApiInteractionConsentGet200ResponseOrganizationsInnerMissingResourceScopesInnerScopesInner.from_dict(_item) for _item in obj["scopes"]] if obj.get("scopes") is not None else None
        })
        return _obj
