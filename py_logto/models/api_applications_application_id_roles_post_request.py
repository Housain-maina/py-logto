...
class ApiApplicationsApplicationIdRolesPostRequest(BaseModel):
    """
    ApiApplicationsApplicationIdRolesPostRequest
    """ # noqa: E501
    role_ids: List[Annotated[str, Field(min_length=1, strict=True)]] = Field(description="An array of API resource role IDs to assign.", alias="roleIds")
