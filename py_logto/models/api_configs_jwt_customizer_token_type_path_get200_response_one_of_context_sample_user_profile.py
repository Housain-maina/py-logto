...
class ApiConfigsJwtCustomizerTokenTypePathGet200ResponseOneOfContextSampleUserProfile(BaseModel):
    """
    ...
    address: Optional[ApiConfigsJwtCustomizerTokenTypePathGet200ResponseOneOfContextSampleUserProfileAddress] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "address": ApiConfigsJwtCustomizerTokenTypePathGet200ResponseOneOfContextSampleUserProfileAddress.from_dict(obj["address"]) if obj.get("address") is not None else None
        })
        return _obj
