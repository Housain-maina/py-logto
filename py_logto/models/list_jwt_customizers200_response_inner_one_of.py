...
class ListJwtCustomizers200ResponseInnerOneOf(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "key": obj.get("key"),
            "value": GetJwtCustomizer200ResponseOneOf.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
