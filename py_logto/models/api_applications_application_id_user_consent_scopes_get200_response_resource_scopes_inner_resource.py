...
class ApiApplicationsApplicationIdUserConsentScopesGet200ResponseResourceScopesInnerResource(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "indicator"]
