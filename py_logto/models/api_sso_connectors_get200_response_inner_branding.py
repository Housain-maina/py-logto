...
class ApiSsoConnectorsGet200ResponseInnerBranding(BaseModel):
    """
    ApiSsoConnectorsGet200ResponseInnerBranding
    """ # noqa: E501
    display_name: Optional[StrictStr] = Field(default=None, alias="displayName")
    logo: Optional[StrictStr] = None
    dark_logo: Optional[StrictStr] = Field(default=None, alias="darkLogo")
    __properties: ClassVar[List[str]] = ["displayName", "logo", "darkLogo"]
