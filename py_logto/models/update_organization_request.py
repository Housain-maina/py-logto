...
class UpdateOrganizationRequest(BaseModel):
    ...
    id: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=21)]] = None
    name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=128)]] = Field(default=None, description="The updated name of the organization.")
    description: Optional[Annotated[str, Field(strict=True, max_length=256)]] = Field(default=None, description="The updated description of the organization.")
    custom_data: Optional[Dict[str, Any]] = Field(default=None, description="arbitrary", alias="customData")
    is_mfa_required: Optional[StrictBool] = Field(default=None, alias="isMfaRequired")
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "id", "name", "description", "customData", "isMfaRequired", "branding", "createdAt"]
