...
class ApiRolesIdApplicationsPostRequest(BaseModel):
    """
    ApiRolesIdApplicationsPostRequest
    """ # noqa: E501
    application_ids: List[Annotated[str, Field(min_length=1, strict=True)]] = Field(description="An array of application IDs to be assigned.", alias="applicationIds")
