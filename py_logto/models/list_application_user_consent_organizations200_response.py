...
class ListApplicationUserConsentOrganizations200Response(BaseModel):
    """
    ListApplicationUserConsentOrganizations200Response
    """ # noqa: E501
    organizations: List[ListApplicationUserConsentOrganizations200ResponseOrganizationsInner] = Field(description="A list of organization entities granted by the user for the application.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "organizations": [ListApplicationUserConsentOrganizations200ResponseOrganizationsInner.from_dict(_item) for _item in obj["organizations"]] if obj.get("organizations") is not None else None
        })
        return _obj
