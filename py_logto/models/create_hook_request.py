...
class CreateHookRequest(BaseModel):
    ...
    name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=256)]] = Field(default=None, description="The name of the hook.")
    event: Optional[StrictStr] = Field(default=None, description="Use `events` instead.")
    events: Optional[List[StrictStr]] = Field(default=None, description="An array of hook events.")
