...
class ApiApplicationsIdPatchRequestOidcClientMetadata(BaseModel):
    """
    ApiApplicationsIdPatchRequestOidcClientMetadata
    """ # noqa: E501
    redirect_uris: Optional[List[ApiApplicationsGet200ResponseInnerOidcClientMetadataRedirectUrisInner]] = Field(default=None, alias="redirectUris")
