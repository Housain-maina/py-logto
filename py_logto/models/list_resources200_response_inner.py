...
class ListResources200ResponseInner(BaseModel):
    """
    ...
    scopes: Optional[List[ListResources200ResponseInnerScopesInner]] = None
    __properties: ClassVar[List[str]] = ["tenantId", "id", "name", "indicator", "isDefault", "accessTokenTtl", "scopes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "scopes": [ListResources200ResponseInnerScopesInner.from_dict(_item) for _item in obj["scopes"]] if obj.get("scopes") is not None else None
        })
        return _obj
