...
class VerifyVerificationCodeRequestOneOf1(BaseModel):
    """
    VerifyVerificationCodeRequestOneOf1
    """ # noqa: E501
    phone: Annotated[str, Field(strict=True)]
    verification_code: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="verificationCode")
    __properties: ClassVar[List[str]] = ["phone", "verificationCode"]
