...
class ApiUsersUserIdIsSuspendedPatchRequest(BaseModel):
    """
    ApiUsersUserIdIsSuspendedPatchRequest
    """ # noqa: E501
    is_suspended: StrictBool = Field(description="New suspension status for the user.", alias="isSuspended")
    __properties: ClassVar[List[str]] = ["isSuspended"]
