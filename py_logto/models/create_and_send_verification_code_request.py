...
class CreateAndSendVerificationCodeRequest(BaseModel):
    """
    CreateAndSendVerificationCodeRequest
    """ # noqa: E501
    identifier: CreateAndSendVerificationCodeRequestIdentifier
    interaction_event: StrictStr = Field(description="The interaction event for which the verification code will be used. Supported values are `SignIn`, `Register`, and `ForgotPassword`. This determines the template for the verification code.", alias="interactionEvent")
    __properties: ClassVar[List[str]] = ["identifier", "interactionEvent"]

    @field_validator('interaction_event')
    def interaction_event_validate_enum(cls, value):
        """Validates the enum"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "identifier": CreateAndSendVerificationCodeRequestIdentifier.from_dict(obj["identifier"]) if obj.get("identifier") is not None else None,
            "interactionEvent": obj.get("interactionEvent")
        })
        return _obj
