...
class ApiSignInExpGet200ResponsePasswordPolicyLength(BaseModel):
    """
    ApiSignInExpGet200ResponsePasswordPolicyLength
    """ # noqa: E501
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "min": obj.get("min") if obj.get("min") is not None else 8,
            "max": obj.get("max") if obj.get("max") is not None else 256
        })
        return _obj
