...
class ApiConfigsJwtCustomizerTokenTypePathGet200ResponseOneOf(BaseModel):
    """
    ApiConfigsJwtCustomizerTokenTypePathGet200ResponseOneOf
    """ # noqa: E501
    ...
    context_sample: Optional[ApiConfigsJwtCustomizerTokenTypePathGet200ResponseOneOfContextSample] = Field(default=None, alias="contextSample")
    token_sample: Optional[ApiConfigsJwtCustomizerTokenTypePathGet200ResponseOneOfTokenSample] = Field(default=None, alias="tokenSample")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contextSample": ApiConfigsJwtCustomizerTokenTypePathGet200ResponseOneOfContextSample.from_dict(obj["contextSample"]) if obj.get("contextSample") is not None else None,
            "tokenSample": ApiConfigsJwtCustomizerTokenTypePathGet200ResponseOneOfTokenSample.from_dict(obj["tokenSample"]) if obj.get("tokenSample") is not None else None
        })
        return _obj
