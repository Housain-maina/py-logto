...
class GetAccountCenterSettings200Response(BaseModel):
    """
    ...
    enabled: StrictBool
    fields: GetAccountCenterSettings200ResponseFields
    __properties: ClassVar[List[str]] = ["tenantId", "id", "enabled", "fields"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fields": GetAccountCenterSettings200ResponseFields.from_dict(obj["fields"]) if obj.get("fields") is not None else None
        })
        return _obj
