...
class ApiUsersUserIdPatch200Response(BaseModel):
    """
    ...
    sso_identities: Optional[List[ApiUsersUserIdGet200ResponseSsoIdentitiesInner]] = Field(default=None, alias="ssoIdentities")
