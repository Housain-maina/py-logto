...
class CheckPasswordWithDefaultSignInExperience200ResponseOneOf1IssuesInner(BaseModel):
    """
    CheckPasswordWithDefaultSignInExperience200ResponseOneOf1IssuesInner
    """ # noqa: E501
    code: StrictStr
    interpolation: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["code", "interpolation"]
